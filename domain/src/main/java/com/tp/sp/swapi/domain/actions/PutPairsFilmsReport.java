...
public class PutPairsFilmsReport {

  private final GenerateReport<Flux<Report>> generatePairsFilmsReport;
  private final ReportQueryRepository reportQueryRepository;
  private final ReportRepository reportRepository;

  public Flux<Report> putReport(int reportId, QueryCriteria queryCriteria) {
    return generatePairsFilmsReport.generateReport(reportId, queryCriteria)
